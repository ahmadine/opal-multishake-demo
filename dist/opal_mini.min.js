...
b){c.const_cache_version++;if(null!=a.$$const[b]){var e=a.$$const[b];delete a.$$const[b];return e}if(null!=a.$$autoload&&null!=a.$$autoload[b])return delete a.$$autoload[b],C;throw c.NameError.$new("constant "+a+"::"+a.$name()+" not defined");};c.allocate_class=function(e,b){var d=null!=b&&b.$$bridge?function(){var a=t.call(arguments);a=new (w.apply(b.$$constructor,[null].concat(a)));k(a,x.$$prototype);return a}:function(){};e&&a(d,"displayName","::"+e);var x=d;a(x,"$$name",e);a(x,"$$constructor",
d);a(x,"$$prototype",d.prototype);a(x,"$$const",{});a(x,"$$is_class",!0);a(x,"$$is_a_module",!0);a(x,"$$super",b);a(x,"$$cvars",{});a(x,"$$own_included_modules",[]);a(x,"$$own_prepended_modules",[]);a(x,"$$ancestors",[]);a(x,"$$ancestors_cache_version",null);a(x.$$prototype,"$$class",x);c.Class&&k(x,c.Class.prototype);null!=b&&(k(x.$$prototype,b.$$prototype),b.$$meta&&c.build_class_singleton_class(x));return x};c.klass=function(a,b,d){null==a?a=B:a.$$is_class||a.$$is_module||(a=a.$$class);if(null!=
b&&!b.hasOwnProperty("$$is_class")){var e=b;b=B}var x;if(x=n(a,d)){if(!x.$$is_class)throw c.TypeError.$new(d+" is not a class");}else x=void 0;if(x){if(b&&x.$$super!==b)throw c.TypeError.$new("superclass mismatch for class "+x.$$name);return x}null==b&&(b=B);x=c.allocate_class(d,b);c.const_set(a,d,x);b.$inherited&&b.$inherited(x);e&&c.bridge(e,x);return x};c.allocate_module=function(e){var b=function(){};e&&a(b,"displayName",e+".$$constructor");e&&a(b,"displayName",e+".constructor");a(b,"$$name",
e);a(b,"$$prototype",b.prototype);a(b,"$$const",{});a(b,"$$is_module",!0);a(b,"$$is_a_module",!0);a(b,"$$cvars",{});a(b,"$$iclasses",[]);a(b,"$$own_included_modules",[]);a(b,"$$own_prepended_modules",[]);a(b,"$$ancestors",[b]);a(b,"$$ancestors_cache_version",null);k(b,c.Module.prototype);return b};c.module=function(a,b){null==a?a=B:a.$$is_class||a.$$is_module||(a=a.$$class);var e=a;var d=n(e,b);null==d&&e===B&&(d=q(B,b));if(d&&!d.$$is_module&&d!==B)throw c.TypeError.$new(b+" is not a module");if(e=
d)return e;e=c.allocate_module(b);c.const_set(a,b,e);return e};c.get_singleton_class=function(a){return a.$$meta?a.$$meta:a.hasOwnProperty("$$is_class")?c.build_class_singleton_class(a):a.hasOwnProperty("$$is_module")?c.build_module_singletin_class(a):c.build_object_singleton_class(a)};c.build_class_singleton_class=function(e){if(e.$$meta)return e.$$meta;var b=e===m?y:c.get_singleton_class(e.$$super);b=c.allocate_class(null,b,function(){});a(b,"$$is_singleton",!0);a(b,"$$singleton_of",e);a(e,"$$meta",
b);k(e,b.$$prototype);a(e,"$$class",c.Class);return b};c.build_module_singletin_class=function(e){if(e.$$meta)return e.$$meta;var b=c.allocate_class(null,c.Module,function(){});a(b,"$$is_singleton",!0);a(b,"$$singleton_of",e);a(e,"$$meta",b);k(e,b.$$prototype);a(e,"$$class",c.Module);return b};c.build_object_singleton_class=function(e){var b=c.allocate_class(C,e.$$class,function(){});a(b,"$$is_singleton",!0);a(b,"$$singleton_of",e);delete b.$$prototype.$$class;a(e,"$$meta",b);k(e,e.$$meta.$$prototype);
return b};c.is_method=function(a){return"$"===a[0]&&"$"!==a[1]};c.instance_methods=function(a){var e=[],b=[];a=c.ancestors(a);for(var d=0,f=a.length;d<f;d++){var g=a[d].$$prototype;g.hasOwnProperty("$$dummy")&&(g=g.$$define_methods_on);for(var h=Object.getOwnPropertyNames(g),k=0,m=h.length;k<m;k++){var l=h[k];if(c.is_method(l)){var p=l.slice(1);l=g[l];l.$$stub&&-1===e.indexOf(p)&&e.push(p);l.$$stub||-1!==b.indexOf(p)||-1!==e.indexOf(p)||b.push(p)}}}return b};c.own_instance_methods=function(a){var e=
[];a=a.$$prototype;a.hasOwnProperty("$$dummy")&&(a=a.$$define_methods_on);for(var b=Object.getOwnPropertyNames(a),d=0,g=b.length;d<g;d++){var f=b[d];c.is_method(f)&&!a[f].$$stub&&(f=f.slice(1),e.push(f))}return e};c.methods=function(a){return c.instance_methods(c.get_singleton_class(a))};c.own_methods=function(a){return c.own_instance_methods(c.get_singleton_class(a))};c.receiver_methods=function(a){var e=c.get_singleton_class(a);a=c.own_instance_methods(e);e=c.own_instance_methods(e.$$super);return a.concat(e)};
c.class_variables=function(a){a=c.ancestors(a);var e,b={};for(e=a.length-1;0<=e;e--){var d=a[e],f;for(f in d.$$cvars)b[f]=d.$$cvars[f]}return b};c.class_variable_set=function(a,b,d){var e=c.ancestors(a),x;for(x=e.length-2;0<=x;x--){var f=e[x];if(u.call(f.$$cvars,b))return f.$$cvars[b]=d}return a.$$cvars[b]=d};c.append_features=function(e,b){var d=c.ancestors(e),x=[];if(-1!==d.indexOf(b))throw c.ArgumentError.$new("cyclic include detected");for(var m=0,l=d.length;m<l;m++){var v=h(d[m]);a(v,"$$included",
!0);x.push(v)}d=c.ancestors(b);x=g(x);if(-1===d.indexOf(e))e=b.$$prototype,d=Object.getPrototypeOf(b.$$prototype);else{d=b.$$prototype;for(m=Object.getPrototypeOf(d);null!=m&&(!f(m)||m.$$module!==e);)d=m,m=Object.getPrototypeOf(m);for(m=Object.getPrototypeOf(m);m.hasOwnProperty("$$iclass")&&!f(m);)m=Object.getPrototypeOf(m);e=d;d=m}k(e,x.first);k(x.last,d);e=[];for(d=Object.getPrototypeOf(b.$$prototype);d&&!d.hasOwnProperty("$$class");)(x=p(d))&&e.push(x),d=Object.getPrototypeOf(d);b.$$own_included_modules=
e;c.const_cache_version++};c.prepend_features=function(e,d){var x=c.ancestors(e),f=[];if(-1!==x.indexOf(d))throw c.ArgumentError.$new("cyclic prepend detected");for(var m=0,l=x.length;m<l;m++){var v=h(x[m]);a(v,"$$prepended",!0);f.push(v)}x=g(f);m=d.$$prototype;l=Object.getPrototypeOf(m);if(m.hasOwnProperty("$$dummy"))f=m.$$define_methods_on;else{f=b(d);v=d.$$prototype;for(var t=Object.getOwnPropertyNames(v),r=0;r<t.length;r++){var n=t[r];c.is_method(n)&&delete v[n]}a(m,"$$dummy",!0);a(m,"$$define_methods_on",
f);k(m,f);k(f,l)}if(-1===c.ancestors(d).indexOf(e))for(e=m,m=Object.getPrototypeOf(m);null!=m&&!m.hasOwnProperty("$$root")&&m!==f&&m.hasOwnProperty("$$iclass");)m=Object.getPrototypeOf(m);else throw c.RuntimeError.$new("Prepending a module multiple times is not supported");k(e,x.first);k(x.last,m);e=[];f=Object.getPrototypeOf(d.$$prototype);if(d.$$prototype.hasOwnProperty("$$dummy"))for(;f&&f!==d.$$prototype.$$define_methods_on;)(x=p(f))&&e.push(x),f=Object.getPrototypeOf(f);d.$$own_prepended_modules=
e;c.const_cache_version++};c.bridge=function(e,b){if(e.hasOwnProperty("$$bridge"))throw c.ArgumentError.$new("already bridged");a(e,"$$bridge",b);k(e.prototype,(b.$$super||c.Object).$$prototype);a(b,"$$prototype",e.prototype);a(b.$$prototype,"$$class",b);a(b,"$$constructor",e);a(b,"$$bridge",!0)};c.ancestors=function(a){if(!a)return[];if(a.$$ancestors_cache_version===c.const_cache_version)return a.$$ancestors;var e=[],b;var d=0;var f=a.$$own_prepended_modules.concat([a]).concat(a.$$own_included_modules);
for(b=f.length;d<b;d++)e.push(f[d]);if(a.$$super)for(d=0,f=c.ancestors(a.$$super),b=f.length;d<b;d++)e.push(f[d]);a.$$ancestors_cache_version=c.const_cache_version;return a.$$ancestors=e};c.included_modules=function(a){for(var e=[],b=Object.getPrototypeOf(a.$$prototype);b&&Object.getPrototypeOf(b);b=Object.getPrototypeOf(b))(a=p(b))&&a.$$is_module&&b.$$iclass&&b.$$included&&e.push(a);return e};c.add_stubs=function(a){for(var e=c.BasicObject.$$prototype,b=0,d=a.length;b<d;b++){var f=a[b],g=e[f];(null==
g||g.$$stub)&&c.add_stub_for(e,f)}};c.add_stub_for=function(e,b){var d=c.stub_for(b);a(e,b,d)};c.stub_for=function(a){function e(){this.$method_missing.$$p=e.$$p;e.$$p=null;for(var b=Array(arguments.length),c=0,d=b.length;c<d;c++)b[c]=arguments[c];return this.$method_missing.apply(this,[a.slice(1)].concat(b))}e.$$stub=!0;return e};c.ac=function(a,b,d,f){var e="";e=d.$$is_a_module?e+(d.$$name+"."):e+(d.$$class.$$name+"#");throw c.ArgumentError.$new("["+(e+f)+"] wrong number of arguments("+a+" for "+
b+")");};c.block_ac=function(a,b,d){throw c.ArgumentError.$new("`block in "+d+"': wrong number of arguments ("+a+" for "+b+")");};c.find_super_dispatcher=function(a,b,d,f,g){g="$"+b;var e;var x=a.hasOwnProperty("$$meta")?c.ancestors(a.$$meta):c.ancestors(a.$$class);for(d=x.indexOf(d.$$owner)+1;d<x.length;d++){var m=x[d].$$prototype;m.hasOwnProperty("$$dummy")&&(m=m.$$define_methods_on);if(m.hasOwnProperty(g)){g=m[g];g.$$stub||(e=g);break}}if(!f&&null==e&&c.Kernel.$method_missing===a.$method_missing)throw c.NoMethodError.$new("super: no superclass method `"+
b+"' for "+a,b);return e};c.find_iter_super_dispatcher=function(a,b,d,f,g){if(!d)throw c.RuntimeError.$new("super called outside of method");if(g&&d.$$define_meth)throw c.RuntimeError.$new("implicit argument passing of super from method defined by define_method() is not supported. Specify all arguments explicitly");d.$$def&&(b=d.$$jsid);return c.find_super_dispatcher(a,b,d,f)};c.ret=function(a){c.returner.$v=a;throw c.returner;};c.brk=function(a,b){b.$v=a;throw b;};c.new_brk=function(){return Error("unexpected break")};
c.yield1=function(a,b){if("function"!==typeof a)throw c.LocalJumpError.$new("no block given");var e=a.$$has_top_level_mlhs_arg,d=a.$$has_trailing_comma_in_args;if(1<a.length||(e||d)&&1===a.length)b=c.to_ary(b);return(1<a.length||d&&1===a.length)&&b.$$is_array?a.apply(null,b):a(b)};c.yieldX=function(a,b){if("function"!==typeof a)throw c.LocalJumpError.$new("no block given");if(1<a.length&&1===b.length&&b[0].$$is_array)return a.apply(null,b[0]);if(!b.$$is_array){for(var e=Array(b.length),d=0,f=e.length;d<
f;d++)e[d]=b[d];return a.apply(null,e)}return a.apply(null,b)};c.rescue=function(a,b){for(var e=0;e<b.length;e++){var d=b[e];if(d.$$is_array){if(d=c.rescue(a,d))return d}else if(d===c.JS.Error||d["$==="](a))return d}return null};c.is_a=function(a,b){if(null!=b&&a.$$meta===b||a.$$class===b||a.$$is_number&&b.$$is_number_class)return!0;var e,d=c.ancestors(a.$$is_class?c.get_singleton_class(a):a.$$meta||a.$$class);a=0;for(e=d.length;a<e;a++)if(d[a]===b)return!0;return!1};c.to_hash=function(a){if(a.$$is_hash)return a;
if(a["$respond_to?"]("to_hash",!0)){var b=a.$to_hash();if(b.$$is_hash)return b;throw c.TypeError.$new("Can't convert "+a.$$class+" to Hash ("+a.$$class+"#to_hash gives "+b.$$class+")");}throw c.TypeError.$new("no implicit conversion of "+a.$$class+" into Hash");};c.to_ary=function(a){if(a.$$is_array)return a;if(a["$respond_to?"]("to_ary",!0)){var b=a.$to_ary();if(b===C)return[a];if(b.$$is_array)return b;throw c.TypeError.$new("Can't convert "+a.$$class+" to Array ("+a.$$class+"#to_ary gives "+b.$$class+
")");}return[a]};c.to_a=function(a){if(a.$$is_array)return a.slice();if(a["$respond_to?"]("to_a",!0)){var b=a.$to_a();if(b===C)return[a];if(b.$$is_array)return b;throw c.TypeError.$new("Can't convert "+a.$$class+" to Array ("+a.$$class+"#to_a gives "+b.$$class+")");}return[a]};c.extract_kwargs=function(a){var b=a[a.length-1];return null!=b&&b["$respond_to?"]("to_hash",!0)?(G.call(a,a.length-1,1),b.$to_hash()):c.hash2([],{})};c.kwrestargs=function(a,b){var e=[],d={},f;a=a.$$smap;for(f in a)b[f]||(e.push(f),
d[f]=a[f]);return c.hash2(e,d)};c.send=function(a,b,c,d){var e="string"===typeof b?a["$"+b]:b;return null!=e?("function"===typeof d&&(e.$$p=d),e.apply(a,c)):a.$method_missing.apply(a,[b].concat(c))};c.lambda=function(a){a.$$is_lambda=!0;return a};c.def=function(a,b,d){a===c.top?c.defn(c.Object,b,d):!a.$$eval&&a.$$is_a_module?c.defn(a,b,d):c.defs(a,b,d)};c.defn=function(b,d,f){f.displayName=d;f.$$owner=b;var e=b.$$prototype;e.hasOwnProperty("$$dummy")&&(e=e.$$define_methods_on);a(e,d,f);if(b.$$is_module){b.$$module_function&&
c.defs(b,d,f);e=0;for(var g=b.$$iclasses,m=g.length;e<m;e++)a(g[e],d,f)}f=b.$$singleton_of;!b.$method_added||b.$method_added.$$stub||f?f&&f.$singleton_method_added&&!f.$singleton_method_added.$$stub&&f.$singleton_method_added(d.substr(1)):b.$method_added(d.substr(1))};c.defs=function(a,b,d){if(a.$$is_string||a.$$is_number)throw c.TypeError.$new("can't define singleton");c.defn(c.get_singleton_class(a),b,d)};c.rdef=function(a,b){if(!u.call(a.$$prototype,b))throw c.NameError.$new("method '"+b.substr(1)+
...
!a.$$prototype.$singleton_method_undefined.$$stub&&a.$$prototype.$singleton_method_undefined(b.substr(1)):a.$method_undefined&&!a.$method_undefined.$$stub&&a.$method_undefined(b.substr(1))};c.alias=function(a,b,d){var e="$"+b,f="$"+d,g=a.$$prototype["$"+d];if(a.$$eval)return c.alias(c.get_singleton_class(a),b,d);if(!v(g)){for(var m=a.$$super;"function"!==typeof g&&m;)g=m[f],m=m.$$super;!v(g)&&a.$$is_module&&(g=c.Object.$$prototype[f]);if(!v(g))throw c.NameError.$new("undefined method `"+d+"' for class `"+
a.$name()+"'");}g.$$alias_of&&(g=g.$$alias_of);var h=function(){var a=h.$$p,b;var e=Array(arguments.length);var d=0;for(b=arguments.length;d<b;d++)e[d]=arguments[d];null!=a&&(h.$$p=null);return c.send(this,g,e,a)};Object.defineProperty(h,"length",{value:g.length});h.displayName=b;h.$$arity=g.$$arity;h.$$parameters=g.$$parameters;h.$$source_location=g.$$source_location;h.$$alias_of=g;h.$$alias_name=b;c.defn(a,e,h);return a};c.alias_native=function(a,b,d){b="$"+b;var e=a.$$prototype[d];if("function"!==
typeof e||e.$$stub)throw c.NameError.$new("undefined native method `"+d+"' for class `"+a.$name()+"'");c.defn(a,b,e);return a};c.hash_init=function(a){a.$$smap=Object.create(null);a.$$map=Object.create(null);a.$$keys=[]};c.hash_clone=function(a,b){b.$$none=a.$$none;b.$$proc=a.$$proc;var e=0,d=a.$$keys;a=a.$$smap;for(var f=d.length,g,m;e<f;e++)g=d[e],g.$$is_string?m=a[g]:(m=g.value,g=g.key),c.hash_put(b,g,m)};c.hash_put=function(a,b,d){if(b.$$is_string)u.call(a.$$smap,b)||a.$$keys.push(b),a.$$smap[b]=
d;else{var e;var f=a.$$by_identity?c.id(b):b.$hash();if(u.call(a.$$map,f)){for(e=a.$$map[f];e;){if(b===e.key||b["$eql?"](e.key)){var g=void 0;e.value=d;break}g=e;e=e.next}g&&(e={key:b,key_hash:f,value:d},a.$$keys.push(e),g.next=e)}else e={key:b,key_hash:f,value:d},a.$$keys.push(e),a.$$map[f]=e}};c.hash_get=function(a,b){if(b.$$is_string){if(u.call(a.$$smap,b))return a.$$smap[b]}else{var d=a.$$by_identity?c.id(b):b.$hash();if(u.call(a.$$map,d))for(a=a.$$map[d];a;){if(b===a.key||b["$eql?"](a.key))return a.value;
a=a.next}}};c.hash_delete=function(a,b){var c,d=a.$$keys,e=d.length;if(b.$$is_string){if(!u.call(a.$$smap,b))return;for(c=0;c<e;c++)if(d[c]===b){d.splice(c,1);break}var f=a.$$smap[b];delete a.$$smap[b];return f}var g=b.$hash();if(u.call(a.$$map,g))for(var m=a.$$map[g],h;m;){if(b===m.key||b["$eql?"](m.key)){f=m.value;for(c=0;c<e;c++)if(d[c]===m){d.splice(c,1);break}h&&m.next?h.next=m.next:h?delete h.next:m.next?a.$$map[g]=m.next:delete a.$$map[g];return f}h=m;m=m.next}};c.hash_rehash=function(a){for(var b=
...
c.hash=function(){var a=arguments.length,b;if(1===a&&arguments[0].$$is_hash)return arguments[0];var d=new c.Hash;c.hash_init(d);if(1===a&&arguments[0].$$is_array){a=arguments[0];var f=a.length;for(b=0;b<f;b++){if(2!==a[b].length)throw c.ArgumentError.$new("value not of length 2: "+a[b].$inspect());var g=a[b][0];var m=a[b][1];c.hash_put(d,g,m)}return d}if(1===a){a=arguments[0];for(g in a)u.call(a,g)&&(m=a[g],c.hash_put(d,g,m));return d}if(0!==a%2)throw c.ArgumentError.$new("odd number of arguments for Hash");
for(b=0;b<a;b+=2)g=arguments[b],m=arguments[b+1],c.hash_put(d,g,m);return d};c.hash2=function(a,b){var d=new c.Hash;d.$$smap=b;d.$$map=Object.create(null);d.$$keys=a;return d};c.range=function(a,b,d){var e=new c.Range;e.begin=a;e.end=b;e.excl=d;return e};c.ivar=function(a){return"constructor"===a||"displayName"===a||"__count__"===a||"__noSuchMethod__"===a||"__parent__"===a||"__proto__"===a||"hasOwnProperty"===a||"valueOf"===a?a+"$":a};c.escape_regexp=function(a){return a.replace(/([-[\]\/{}()*+?.^$\\| ])/g,
...
null;return a};c.modules={};c.loaded_features=["corelib/runtime"];c.current_dir=".";c.require_table={"corelib/runtime":!0};c.normalize=function(a){var b=[];"."!==c.current_dir&&(a=c.current_dir.replace(/\/*$/,"/")+a);a=a.replace(/^\.\//,"");a=a.replace(/\.(rb|opal|js)$/,"");a=a.split("/");for(var d=0,e=a.length;d<e;d++){var f=a[d];""!==f&&(".."===f?b.pop():b.push(f))}return b.join("/")};c.loaded=function(a){var b;var d=0;for(b=a.length;d<b;d++){var e=c.normalize(a[d]);c.require_table[e]||(c.loaded_features.push(e),
c.require_table[e]=!0)}};c.load=function(a){a=c.normalize(a);c.loaded([a]);var b=c.modules[a];if(b)b(c);else{b=c.config.missing_require_severity;a="cannot load such file -- "+a;if("error"===b){if(c.LoadError)throw c.LoadError.$new(a);throw a;}"warning"===b&&z.warn("WARNING: LoadError: "+a)}return!0};c.require=function(a){a=c.normalize(a);return c.require_table[a]?!1:c.load(a)};c.encodings=Object.create(null);c.set_encoding=function(a,b){if("string"===typeof a)throw c.FrozenError.$new("can't modify frozen String");
b=c.encodings[b];if(b===a.encoding)return a;a.encoding=b;return a};c.enc=function(a,b){return c.set_encoding(new String(a),b)};c.BasicObject=m=c.allocate_class("BasicObject",null,function(){});c.Object=B=c.allocate_class("Object",c.BasicObject,function(){});c.Module=d=c.allocate_class("Module",c.Object,function(){});c.Class=y=c.allocate_class("Class",c.Module,function(){});k(c.BasicObject,c.Class.$$prototype);k(c.Object,c.Class.$$prototype);k(c.Module,c.Class.$$prototype);k(c.Class,c.Class.$$prototype);
m.$$const.BasicObject=m;c.const_set(B,"BasicObject",m);c.const_set(B,"Object",B);c.const_set(B,"Module",d);c.const_set(B,"Class",y);m.$$class=y;B.$$class=y;d.$$class=y;y.$$class=y;a(B.$$prototype,"toString",function(){var a=this.$to_s();return a.$$is_string&&"object"===typeof a?a.valueOf():a});a(B.$$prototype,"$require",c.require);c.$$=B.$$;c.top=new B;c.top.$to_s=c.top.$inspect=function(){return"main"};c.top.$define_method=l;c.NilClass=c.allocate_class("NilClass",c.Object,function(){});c.const_set(B,
"NilClass",c.NilClass);var C=c.nil=new c.NilClass;C.$$id=4;C.call=C.apply=function(){throw c.LocalJumpError.$new("no block given");};c.breaker=Error("unexpected break (old)");c.returner=Error("unexpected return");TypeError.$$super=Error}).call();Opal.loaded(["corelib/runtime.js"]);
Opal.modules["corelib/helpers"]=function(a){var n=[],q=a.nil,r=a.const_get_relative,f=a.module,h=a.truthy,b=a.send;a.add_stubs("$new $class $=== $respond_to? $raise $type_error $__send__ $coerce_to $nil? $<=> $coerce_to! $!= $[] $upcase".split(" "));return function(g,p){g=f(g,"Opal");var v=[g].concat(p),l,d,n,m,B,y,c,u,w,k,t,G,E,C;a.defs(g,"$bridge",l=function(b,d){return a.bridge(b,d)},l.$$arity=2);a.defs(g,"$type_error",d=function(a,b,d,c){var e;null==d&&(d=q);null==c&&(c=q);return h(h(e=d)?c:e)?
r(v,"TypeError").$new("can't convert "+a.$class()+" into "+b+" ("+a.$class()+"#"+d+" gives "+c.$class()+")"):r(v,"TypeError").$new("no implicit conversion of "+a.$class()+" into "+b)},d.$$arity=-3);a.defs(g,"$coerce_to",n=function(d,c,f,g){var e=a.slice.call(arguments,3,arguments.length);if(h(c["$==="](d)))return d;h(d["$respond_to?"](f))||this.$raise(this.$type_error(d,c));return b(d,"__send__",[f].concat(a.to_a(e)))},n.$$arity=-4);a.defs(g,"$coerce_to!",m=function(d,c,f,g){var e=a.slice.call(arguments,
3,arguments.length);e=b(this,"coerce_to",[d,c,f].concat(a.to_a(e)));h(c["$==="](e))||this.$raise(this.$type_error(d,c,f,e));return e},m.$$arity=-4);a.defs(g,"$coerce_to?",B=function(d,c,f,g){var e=a.slice.call(arguments,3,arguments.length);if(!h(d["$respond_to?"](f)))return q;e=b(this,"coerce_to",[d,c,f].concat(a.to_a(e)));if(h(e["$nil?"]()))return q;h(c["$==="](e))||this.$raise(this.$type_error(d,c,f,e));return e},B.$$arity=-4);a.defs(g,"$try_convert",y=function(a,b,d){return h(b["$==="](a))?a:h(a["$respond_to?"](d))?
...
Opal.modules["corelib/class"]=function(a){var n=a.top,q=[],r=a.nil,f=a.const_get_relative,h=a.klass,b=a.send;a.add_stubs("$require $class_eval $to_proc $initialize_copy $allocate $name $to_s".split(" "));n.$require("corelib/module");return function(g,$super,v){g=h(g,$super,"Class");var l=[g].concat(v),d,n,m,q,y,c,u;a.defs(g,"$new",d=function(c){var g=d.$$p,m=g||r;g&&(d.$$p=null);g&&(d.$$p=null);null==c&&(c=f(l,"Object"));if(!c.$$is_class)throw a.TypeError.$new("superclass must be a Class");g=a.allocate_class(r,
c);c.$inherited(g);m!==r&&b(g,"class_eval",[],m.$to_proc());return g},d.$$arity=-1);a.def(g,"$allocate",n=function(){var b=new this.$$constructor;b.$$id=a.uid();return b},n.$$arity=0);a.def(g,"$inherited",m=function(a){return r},m.$$arity=1);a.def(g,"$initialize_dup",q=function(a){this.$initialize_copy(a);this.$$full_name=this.$$name=null},q.$$arity=1);a.def(g,"$new",y=function(b){var d=y.$$p,c=d||r;d&&(y.$$p=null);d&&(y.$$p=null);d=a.slice.call(arguments,0,arguments.length);var f=this.$allocate();
a.send(f,f.$initialize,d,c);return f},y.$$arity=-1);a.def(g,"$superclass",c=function(){return this.$$super||r},c.$$arity=0);return(a.def(g,"$to_s",u=function(){u.$$p&&(u.$$p=null);var d=this.$$singleton_of;return d&&d.$$is_a_module?"#<Class:"+d.$name()+">":d?"#<Class:#<"+d.$$class.$name()+":0x"+a.id(d).$to_s(16)+">>":b(this,a.find_super_dispatcher(this,"to_s",u,!1),[],null)},u.$$arity=0),r)&&"to_s"}(q[0],null,q)};
Opal.modules["corelib/basic_object"]=function(a){var n=[],q=a.nil,r=a.const_get_qualified,f=a.klass,h=a.truthy,b=a.range,g=a.hash2,p=a.send;a.add_stubs("$== $! $nil? $cover? $size $raise $merge $compile $proc $any? $inspect $new".split(" "));return function(v,$super,d){v=f(v,$super,"BasicObject");[v].concat(d);var n,m,B,y,c,u,w,k,t,G,E,C,e,x,D;a.def(v,"$initialize",n=function(b){a.slice.call(arguments,0,arguments.length);return q},n.$$arity=-1);a.def(v,"$==",m=function(a){return this===a},m.$$arity=
1);a.def(v,"$eql?",B=function(a){return this["$=="](a)},B.$$arity=1);a.alias(v,"equal?","==");a.def(v,"$__id__",y=function(){if(null!=this.$$id)return this.$$id;a.defineProperty(this,"$$id",a.uid());return this.$$id},y.$$arity=0);a.def(v,"$__send__",c=function(b,d){var f=c.$$p,e=f||q;f&&(c.$$p=null);f&&(c.$$p=null);f=a.slice.call(arguments,1,arguments.length);var g=this["$"+b];if(g)return e!==q&&(g.$$p=e),g.apply(this,f);e!==q&&(this.$method_missing.$$p=e);return this.$method_missing.apply(this,[b].concat(f))},
c.$$arity=-2);a.def(v,"$!",u=function(){return!1},u.$$arity=0);a.def(v,"$!=",w=function(a){return this["$=="](a)["$!"]()},w.$$arity=1);a.def(v,"$instance_eval",k=function(d){var c=k.$$p,f=c||q,e,m,v=q,t=q,n=t=t=q;c&&(k.$$p=null);c&&(k.$$p=null);c=a.slice.call(arguments,0,arguments.length);h(h(e=f["$nil?"]())?!!a.compile:e)?(h(b(1,3,!1)["$cover?"](c.$size()))||r("::","Kernel").$raise(r("::","ArgumentError"),"wrong number of arguments (0 for 1..3)"),e=[].concat(a.to_a(c)),v=null==e[0]?q:e[0],t=null==
e[1]?q:e[1],e,t=g(["file","eval"],{file:h(e=t)?e:"(eval)",eval:!0}),t=a.hash({arity_check:!1}).$merge(t),n=r("::","Opal").$compile(v,t),f=p(r("::","Kernel"),"proc",[],(m=function(){return function(a){return eval(n)}(null==m.$$s?this:m.$$s)},m.$$s=this,m.$$arity=0,m))):h(c["$any?"]())&&r("::","Kernel").$raise(r("::","ArgumentError"),"wrong number of arguments ("+c.$size()+" for 0)");e=f.$$s;f.$$s=null;if(this.$$is_a_module){this.$$eval=!0;try{var u=f.call(this,this)}finally{this.$$eval=!1}}else u=
f.call(this,this);f.$$s=e;return u},k.$$arity=-1);a.def(v,"$instance_exec",t=function(b){var d=t.$$p,c=d||q;d&&(t.$$p=null);d&&(t.$$p=null);d=a.slice.call(arguments,0,arguments.length);h(c)||r("::","Kernel").$raise(r("::","ArgumentError"),"no block given");var f=c.$$s;c.$$s=null;if(this.$$is_a_module){this.$$eval=!0;try{var e=c.apply(this,d)}finally{this.$$eval=!1}}else e=c.apply(this,d);c.$$s=f;return e},t.$$arity=-1);a.def(v,"$singleton_method_added",G=function(b){a.slice.call(arguments,0,arguments.length);
...
"Kernel"))}(q[0],null,q)};
Opal.modules["corelib/error"]=function(a){var n=[],q=a.nil,r=a.const_get_relative,f=a.klass,h=a.send,b=a.truthy,g=a.module,p=a.hash2;a.add_stubs("$new $clone $to_s $empty? $class $raise $+ $attr_reader $[] $> $length $inspect".split(" "));(function(g,$super,d){g=f(g,$super,"Exception");var p=[g].concat(d),m,v,n,c,u,w,k,t,G;g.$$prototype.message=q;a.defs(g,"$new",m=function(b){var d=a.slice.call(arguments,0,arguments.length);var c=0<d.length?d[0]:q,f=new this.$$constructor(c);f.name=this.$$name;f.message=
c;a.send(f,f.$initialize,d);a.config.enable_stack_trace&&Error.captureStackTrace&&Error.captureStackTrace(f,E);return f},m.$$arity=-1);var E=g.$new;a.defs(g,"$exception",v=function(b){var d=a.slice.call(arguments,0,arguments.length);return h(this,"new",a.to_a(d))},v.$$arity=-1);a.def(g,"$initialize",n=function(b){var d=a.slice.call(arguments,0,arguments.length);return this.message=0<d.length?d[0]:q},n.$$arity=-1);a.def(g,"$backtrace",c=function(){if(this.backtrace)return this.backtrace;var a=this.stack;
return"string"===typeof a?a.split("\n").slice(0,15):a?a.slice(0,15):[]},c.$$arity=0);a.def(g,"$exception",u=function(a){null==a&&(a=q);if(a===q||this===a)return this;var b=this.$clone();b.message=a;b.stack=this.stack;return b},u.$$arity=-1);a.def(g,"$message",w=function(){return this.$to_s()},w.$$arity=0);a.def(g,"$inspect",k=function(){var a=this.$to_s();return b(a["$empty?"]())?this.$class().$to_s():"#<"+this.$class().$to_s()+": "+this.$to_s()+">"},k.$$arity=0);a.def(g,"$set_backtrace",t=function(a){var b=
!0,d;if(a===q)this.backtrace=q,this.stack="";else if(a.$$is_string)this.backtrace=[a],this.stack=a;else{if(a.$$is_array){var c=0;for(d=a.length;c<d;c++)if(!a[c].$$is_string){b=!1;break}}else b=!1;!1===b&&this.$raise(r(p,"TypeError"),"backtrace must be Array of String");this.backtrace=a;this.stack=a.join("\n")}return a},t.$$arity=1);return(a.def(g,"$to_s",G=function(){var a,d;return b(a=b(d=this.message)?this.message.$to_s():d)?a:this.$class().$to_s()},G.$$arity=0),q)&&"to_s"})(n[0],Error,n);(function(a,
...
Opal.modules["corelib/boolean"]=function(a){var n=[],q=a.nil,r=a.const_get_relative,f=a.klass,h=a.hash2;a.add_stubs(["$raise","$name"]);(function(b,$super,p){b=f(b,$super,"Boolean");var n=[b].concat(p),l,d,z,m,B,y,c,u,w,k;a.defineProperty(b.$$prototype,"$$is_boolean",!0);a.defineProperty(b.$$prototype,"$$meta",b);(function(b,d){var c=[b].concat(d),f;a.def(b,"$allocate",f=function(){return this.$raise(r(c,"TypeError"),"allocator undefined for "+this.$name())},f.$$arity=0);a.udef(b,"$new");return q})(a.get_singleton_class(b),
...
Opal.modules["corelib/comparable"]=function(a){function n(a,b){return"number"===typeof a&&"number"===typeof b?a>b:a["$>"](b)}function q(a,b){return"number"===typeof a&&"number"===typeof b?a<b:a["$<"](b)}var r=[],f=a.nil,h=a.const_get_relative,b=a.module,g=a.truthy;a.add_stubs("$> $< $=== $raise $class $equal? $<=>".split(" "));return function(p,r){function l(b){return a.is_a(b,a.Integer)?b:n(b,0)?1:q(b,0)?-1:0}function d(a,b){G=b;b=f["$==="](G)||(!0)["$==="](G)||(!1)["$==="](G)||h(m,"Integer")["$==="](G)||
h(m,"Float")["$==="](G)?b.$inspect():b.$$class;v.$raise(h(m,"ArgumentError"),"comparison of "+a.$class()+" with "+b+" failed")}var v=b(p,"Comparable"),m=[v].concat(r),B,y,c,u,w,k,t,G=f;a.def(v,"$==",B=function(b){var d;return g(this["$equal?"](b))?!0:this["$<=>"]==a.Kernel["$<=>"]?!1:this.$$comparable?(delete this.$$comparable,!1):g(d=this["$<=>"](b))?0==l(d):!1},B.$$arity=1);a.def(v,"$>",y=function(a){var b;g(b=this["$<=>"](a))||d(this,a);return 0<l(b)},y.$$arity=1);a.def(v,"$>=",c=function(a){var b;
...
l(this["$<=>"](a)))?a:g(0<l(this["$<=>"](b)))?b:this},t.$$arity=2)}(r[0],r)};
Opal.modules["corelib/regexp"]=function(a){var n=[],q=a.nil,r=a.const_get_relative,f=a.klass,h=a.send,b=a.truthy,g=a.gvars;a.add_stubs("$nil? $[] $raise $escape $options $to_str $new $join $coerce_to! $! $match $coerce_to? $begin $coerce_to $=~ $attr_reader $=== $inspect $to_a".split(" "));(function(a,$super,b){[f(a,$super,"RegexpError")].concat(b);return q})(n[0],r(n,"StandardError"),n);(function(p,$super,l){p=f(p,$super,"Regexp");var d=[p].concat(l),n,m,B,y,c,u,w,k,t,G;a.const_set(d[0],"IGNORECASE",
1);a.const_set(d[0],"EXTENDED",2);a.const_set(d[0],"MULTILINE",4);a.defineProperty(p.$$prototype,"$$is_regexp",!0);(function(d,c){var f=[d].concat(c),m,k,l,p,n;a.def(d,"$allocate",m=function(){var b=m.$$p,d;b&&(m.$$p=null);var c=0;var f=arguments.length;for(d=Array(f);c<f;c++)d[c]=arguments[c];b=h(this,a.find_super_dispatcher(this,"allocate",m,!1),d,b);b.uninitialized=!0;return b},m.$$arity=0);a.def(d,"$escape",k=function(b){return a.escape_regexp(b)},k.$$arity=1);a.def(d,"$last_match",l=function(a){null==
g["~"]&&(g["~"]=q);null==a&&(a=q);return b(a["$nil?"]())?g["~"]:g["~"]["$[]"](a)},l.$$arity=-1);a.alias(d,"quote","escape");a.def(d,"$union",p=function(b){var d=a.slice.call(arguments,0,arguments.length);if(0==d.length)return/(?!)/;if(1==d.length&&d[0].$$is_regexp)return d[0];var c=d[0].$$is_array;1<d.length&&c&&this.$raise(r(f,"TypeError"),"no implicit conversion of Array into String");c&&(d=d[0]);var e=void 0;c=[];for(var g=0;g<d.length;g++){var m=d[g];if(m.$$is_string)c.push(this.$escape(m));else if(m.$$is_regexp){var h=
...
Opal.modules["corelib/string"]=function(a){function n(a,b){return"number"===typeof a&&"number"===typeof b?a/b:a["$/"](b)}function q(a,b){return"number"===typeof a&&"number"===typeof b?a+b:a["$+"](b)}var r=a.top,f=[],h=a.nil,b=a.const_get_qualified,g=a.const_get_relative,p=a.klass,v=a.truthy,l=a.send,d=a.gvars;a.add_stubs("$require $include $coerce_to? $coerce_to $raise $=== $format $to_s $respond_to? $to_str $<=> $== $=~ $new $force_encoding $casecmp $empty? $ljust $ceil $/ $+ $rjust $floor $to_a $each_char $to_proc $coerce_to! $copy_singleton_methods $initialize_clone $initialize_dup $enum_for $size $chomp $[] $to_i $each_line $encoding $class $match $match? $captures $proc $succ $escape".split(" "));
...
Opal.modules["corelib/enumerable"]=function(a){function n(a,b){return"number"===typeof a&&"number"===typeof b?a>b:a["$>"](b)}function q(a,b){return"number"===typeof a&&"number"===typeof b?a+b:a["$+"](b)}function r(a,b){return"number"===typeof a&&"number"===typeof b?a-b:a["$-"](b)}function f(a,b){return"number"===typeof a&&"number"===typeof b?a<=b:a["$<="](b)}var h=[],b=a.nil,g=a.const_get_qualified,p=a.const_get_relative,v=a.module,l=a.truthy,d=a.send,z=a.falsy,m=a.hash2,B=a.lambda;a.add_stubs("$each $public_send $destructure $to_enum $enumerator_size $new $yield $raise $slice_when $! $enum_for $flatten $map $warn $proc $== $nil? $respond_to? $coerce_to! $> $* $coerce_to $try_convert $< $+ $- $ceil $/ $size $__send__ $length $<= $[] $push $<< $[]= $=== $inspect $<=> $first $reverse $sort $to_proc $take $sort_by $compare $call $dup $to_a $sort! $map! $key? $values $coerce_to? $class $zip".split(" "));
...
Opal.modules["corelib/enumerator"]=function(a){function n(a,b){return"number"===typeof a&&"number"===typeof b?a+b:a["$+"](b)}function q(a,b){return"number"===typeof a&&"number"===typeof b?a<b:a["$<"](b)}var r=a.top,f=[],h=a.nil,b=a.const_get_relative,g=a.breaker,p=a.slice,v=a.klass,l=a.truthy,d=a.send,z=a.falsy;a.add_stubs("$require $include $allocate $new $to_proc $! $respond_to? $coerce_to $nil? $empty? $+ $class $__send__ $call $enum_for $size $destructure $inspect $any? $[] $raise $yield $each $enumerator_size $try_convert $< $=== $for".split(" "));
...
Opal.modules["corelib/numeric"]=function(a){function n(a,b){return"number"===typeof a&&"number"===typeof b?a-b:a["$-"](b)}function q(a,b){return"number"===typeof a&&"number"===typeof b?a*b:a["$*"](b)}function r(a,b){return"number"===typeof a&&"number"===typeof b?a<b:a["$<"](b)}function f(a,b){return"number"===typeof a&&"number"===typeof b?a/b:a["$/"](b)}var h=a.top,b=[],g=a.nil,p=a.const_get_qualified,v=a.const_get_relative,l=a.klass,d=a.truthy,z=a.hash2;a.add_stubs("$require $include $instance_of? $class $Float $respond_to? $coerce $__send__ $=== $raise $equal? $- $* $div $< $-@ $ceil $to_f $denominator $to_r $== $floor $/ $% $Complex $zero? $numerator $abs $arg $coerce_to! $round $to_i $truncate $>".split(" "));
...
b=Math.pow(10,b);var e=Math.floor((Math.abs(e)+b/2)/b)*b;return 0>this?-e:e}m(m(c=this["$nan?"]())?null==b:c)&&this.$raise(d(k,"FloatDomainError"),"NaN");b=d(k,"Opal")["$coerce_to!"](b||0,d(k,"Integer"),"to_int");if(m("number"===typeof b?0>=b:b["$<="](0)))m(this["$nan?"]())?this.$raise(d(k,"RangeError"),"NaN"):m(this["$infinite?"]())&&this.$raise(d(k,"FloatDomainError"),"Infinity");else{if(b["$=="](0))return Math.round(this);if(m(m(c=this["$nan?"]())?c:this["$infinite?"]()))return this}e=d(k,"Math").$frexp(this);
...
Opal.modules["corelib/range"]=function(a){function n(a,b){return"number"===typeof a&&"number"===typeof b?a<=b:a["$<="](b)}function q(a,b){return"number"===typeof a&&"number"===typeof b?a<b:a["$<"](b)}function r(a,b){return"number"===typeof a&&"number"===typeof b?a>b:a["$>"](b)}function f(a,b){return"number"===typeof a&&"number"===typeof b?a+b:a["$+"](b)}var h=a.top,b=[],g=a.nil,p=a.const_get_qualified,v=a.const_get_relative,l=a.klass,d=a.truthy,z=a.send;a.add_stubs("$require $include $attr_reader $raise $<=> $include? $<= $< $enum_for $size $upto $to_proc $respond_to? $class $succ $! $== $=== $exclude_end? $eql? $begin $end $last $to_a $> $- $abs $to_i $coerce_to! $ceil $/ $loop $+ $* $>= $each_with_index $% $bsearch $inspect $[] $hash".split(" "));
...
Opal.modules["corelib/proc"]=function(a){var n=[],q=a.nil,r=a.const_get_relative,f=a.slice,h=a.klass,b=a.truthy;a.add_stubs(["$raise","$coerce_to!"]);return function(g,$super,n){g=h(g,$super,"Proc");var l=[g].concat(n),d,v,m,B,y,c,u,w,k,t;a.defineProperty(g.$$prototype,"$$is_proc",!0);a.defineProperty(g.$$prototype,"$$is_lambda",!1);a.defs(g,"$new",d=function(){var a=d.$$p,c=a||q;a&&(d.$$p=null);a&&(d.$$p=null);b(c)||this.$raise(r(l,"ArgumentError"),"tried to create a Proc object without a block");return c},
d.$$arity=0);a.def(g,"$call",v=function(b){var c=v.$$p,d=c||q;c&&(v.$$p=null);c&&(v.$$p=null);c=a.slice.call(arguments,0,arguments.length);d!==q&&(this.$$p=d);if(d=this.$$brk)try{var e=this.$$is_lambda?this.apply(null,c):a.yieldX(this,c)}catch(x){if(x===d)return d.$v;throw x;}else e=this.$$is_lambda?this.apply(null,c):a.yieldX(this,c);return e},v.$$arity=-1);a.alias(g,"[]","call");a.alias(g,"===","call");a.alias(g,"yield","call");a.def(g,"$to_proc",m=function(){return this},m.$$arity=0);a.def(g,"$lambda?",
...
Opal.modules["corelib/method"]=function(a){var n=[],q=a.nil,r=a.const_get_relative,f=a.klass,h=a.truthy;a.add_stubs("$attr_reader $arity $new $class $join $source_location $raise".split(" "));(function(b,$super,n){b=f(b,$super,"Method");var p=[b].concat(n),l,d,z,m,B,y,c,u,w;b.$$prototype.method=b.$$prototype.receiver=b.$$prototype.owner=b.$$prototype.name=q;b.$attr_reader("owner","receiver","name");a.def(b,"$initialize",l=function(a,b,c,d){this.receiver=a;this.owner=b;this.name=d;return this.method=
c},l.$$arity=4);a.def(b,"$arity",d=function(){return this.method.$arity()},d.$$arity=0);a.def(b,"$parameters",z=function(){return this.method.$$parameters},z.$$arity=0);a.def(b,"$source_location",m=function(){var a;return h(a=this.method.$$source_location)?a:["(eval)",0]},m.$$arity=0);a.def(b,"$comments",B=function(){var a;return h(a=this.method.$$comments)?a:[]},B.$$arity=0);a.def(b,"$call",y=function(b){var c=y.$$p,d=c||q;c&&(y.$$p=null);c&&(y.$$p=null);c=a.slice.call(arguments,0,arguments.length);
...
Opal.modules["corelib/variables"]=function(a){var n=[],q=a.nil,r=a.const_get_relative,f=a.gvars,h=a.hash2;a.add_stubs(["$new"]);f["&"]=f["~"]=f["`"]=f["'"]=q;f.LOADED_FEATURES=f['"']=a.loaded_features;f.LOAD_PATH=f[":"]=[];f["/"]="\n";f[","]=q;a.const_set(n[0],"ARGV",[]);a.const_set(n[0],"ARGF",r(n,"Object").$new());a.const_set(n[0],"ENV",h([],{}));f.VERBOSE=!1;f.DEBUG=!1;return f.SAFE=0};
Opal.modules["corelib/io"]=function(a){function n(a,b){return"number"===typeof a&&"number"===typeof b?a-b:a["$-"](b)}var q=[],r=a.nil,f=a.const_get_qualified,h=a.const_get_relative,b=a.klass,g=a.module,p=a.send,v=a.gvars,l=a.truthy,d=r;a.add_stubs("$attr_accessor $size $write $join $map $String $empty? $concat $chomp $getbyte $getc $raise $new $write_proc= $- $extend".split(" "));(function(d,$super,f){d=b(d,$super,"IO");f=[d].concat(f);var c,m,n,k;d.$$prototype.tty=d.$$prototype.closed=r;a.const_set(f[0],
"SEEK_SET",0);a.const_set(f[0],"SEEK_CUR",1);a.const_set(f[0],"SEEK_END",2);a.def(d,"$tty?",c=function(){return this.tty},c.$$arity=0);a.def(d,"$closed?",m=function(){return this.closed},m.$$arity=0);d.$attr_accessor("write_proc");a.def(d,"$write",n=function(a){this.write_proc(a);return a.$size()},n.$$arity=1);d.$attr_accessor("sync","tty");a.def(d,"$flush",k=function(){return r},k.$$arity=0);(function(b,c){b=g(b,"Writable");[b].concat(c);var d,f,e;a.def(b,"$<<",d=function(a){this.$write(a);return this},
d.$$arity=1);a.def(b,"$print",f=function(b){var c;null==v[","]&&(v[","]=r);var d=a.slice.call(arguments,0,arguments.length);this.$write(p(d,"map",[],(c=function(a){var b=null==c.$$s?this:c.$$s;null==a&&(a=r);return b.$String(a)},c.$$s=this,c.$$arity=1,c)).$join(v[","]));return r},f.$$arity=-1);a.def(b,"$puts",e=function(b){var c,d=r;null==v["/"]&&(v["/"]=r);var e=a.slice.call(arguments,0,arguments.length);d=v["/"];l(e["$empty?"]())?this.$write(v["/"]):this.$write(p(e,"map",[],(c=function(a){var b=
null==c.$$s?this:c.$$s;null==a&&(a=r);return b.$String(a).$chomp()},c.$$s=this,c.$$arity=1,c)).$concat([r]).$join(d));return r},e.$$arity=-1)})(f[0],f);return function(b,c){b=g(b,"Readable");var d=[b].concat(c),f,e,k,l;a.def(b,"$readbyte",f=function(){return this.$getbyte()},f.$$arity=0);a.def(b,"$readchar",e=function(){return this.$getc()},e.$$arity=0);a.def(b,"$readline",k=function(a){null==v["/"]&&(v["/"]=r);return this.$raise(h(d,"NotImplementedError"))},k.$$arity=-1);a.def(b,"$readpartial",l=
function(a,b){return this.$raise(h(d,"NotImplementedError"))},l.$$arity=-2)}(f[0],f)})(q[0],null,q);a.const_set(q[0],"STDERR",v.stderr=h(q,"IO").$new());a.const_set(q[0],"STDIN",v.stdin=h(q,"IO").$new());a.const_set(q[0],"STDOUT",v.stdout=h(q,"IO").$new());var z=a.global.console;d=["object"===typeof process&&"object"===typeof process.stdout?function(a){process.stdout.write(a)}:function(a){z.log(a)}];p(h(q,"STDOUT"),"write_proc=",a.to_a(d));d[n(d.length,1)];d=["object"===typeof process&&"object"===
typeof process.stderr?function(a){process.stderr.write(a)}:function(a){z.warn(a)}];p(h(q,"STDERR"),"write_proc=",a.to_a(d));d[n(d.length,1)];h(q,"STDOUT").$extend(f(h(q,"IO"),"Writable"));return h(q,"STDERR").$extend(f(h(q,"IO"),"Writable"))};
Opal.modules["opal/regexp_anchors"]=function(a){var n=[],q=a.nil,r=a.const_get_relative,f=a.module;a.add_stubs(["$==","$new"]);n=[f(n[0],"Opal")].concat(n);a.const_set(n[0],"REGEXP_START",r(n,"RUBY_ENGINE")["$=="]("opal")?"^":q);a.const_set(n[0],"REGEXP_END",r(n,"RUBY_ENGINE")["$=="]("opal")?"$":q);a.const_set(n[0],"FORBIDDEN_STARTING_IDENTIFIER_CHARS","\\u0001-\\u002F\\u003A-\\u0040\\u005B-\\u005E\\u0060\\u007B-\\u007F");a.const_set(n[0],"FORBIDDEN_ENDING_IDENTIFIER_CHARS","\\u0001-\\u0020\\u0022-\\u002F\\u003A-\\u003E\\u0040\\u005B-\\u005E\\u0060\\u007B-\\u007F");
